...
class NaiveBayes:
  ...
  def classify(self, words):
    ...
    #for pos
    for word in words:
      pos_score += math.log((self.wordCount[(word,'pos')] + 1) * 1.0 / (self.pos_N + len(self.V)))
      neg_score += math.log((self.wordCount[(word,'neg')] + 1) * 1.0 / (self.neg_N + len(self.V)))
    pos_score += math.log(self.pos_C * 1.0 / (self.pos_C + self.neg_C))
    neg_score += math.log(self.neg_C * 1.0 / (self.pos_C + self.neg_C))
  ...
  def addExample(self, klass, words):
    ...
    if klass == 'pos':
      self.pos_C += 1
      self.pos_N += len(words)
    elif klass == 'neg':
      self.neg_C += 1
      self.neg_N += len(words)

    #print '%d,%d,%d,%d' %(self.pos_N,self.pos_V,self.neg_N,self.neg_V)
  # TODO TODO TODO TODO TODO 
  #############################################################################
